...
//
//	/**
//	 *  Gets the keyText attribute of the GetItTogether class
//	 *
...
//	 * @return      Description of the Return Value
//	 */
//	public static String list(InputMap map, ActionMap act) {
...
//			String keyCommand  = keyStroke2String(keys[i]);
...
//			String actionKey   = "";
//			try {
//				actionName = act.get(map.get(keys[i])).getValue(AbstractAction.SHORT_DESCRIPTION).toString();
//			} catch (Exception e) {
//		    }
//			list = list.concat(keyCommand + "\t" + actionName + "\t" + keyCommand + "\n");
//		}
//		return list;
//	}
//
